...
eventdata=[
    ...
    },
    {
        ...
        rules:"<a href='./assets/sabrang_rules.pdf'><button <button style='background-color: red; border-radius: 0'>Click to download</button></a>",
        prizes:"TBA",
        code:"sabrang",
